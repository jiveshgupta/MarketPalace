...
function readURL(input) {
    if (input.files && input.files[0]) {
        ...
        for (const element in input.files) {
            ...
            console.log('element :',element ,'****',input_filesList[element] ,'******', input.files[element] );
        }
        console.log('input_filesList :',input_filesList);
        console.log('input_files :',input.files);
        console.log('input_filesList :',input_filesList.length);
        console.log('input_files :',input.files.length);
        ...
        for (i = 0; i < input_filesList.length; i++) {
            formData.append('productImage', input.files[i] );
